"""
Фикстуры для тестирования функций-генераторов.
"""
...
def transactions_without_currency() -> List[Dict[str, Any]]:
    """Фикстура с транзакциями, у которых отсутствует информация о валюте."""
    return [
        {"id": 1, "description": "Тестовая транзакция"},
        {"id": 2, "operationAmount": {}, "description": "Без валюты"},
        {
            "id": 3,
            "operationAmount": {"currency": {}},
            "description": "Пустая валюта",
        },
    ]
